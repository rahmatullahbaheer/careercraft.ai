    ...
    >
      ...
      <div className="flex flex-col gap-6">
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (resumeType === value) {
                          ...
                          dispatch(setState({ name: "resumeType", value: "resume-basic" }));
                        ...
                        const newValue = value as "resume-basic" | "resume-job-title" | "resume-job-description";
                        ...
                        dispatch(setState({ name: "resumeType", value: newValue }));
                      }}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${resumeType === value ? "bg-purple-600" : "bg-gray-200 dark:bg-gray-600"
                        }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${resumeType === value ? "translate-x-6" : "translate-x-1"
                          }`}
                      />
                    </button>
        ...
        <button
          ...
          className={` bg-purple-600 w-fit hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 ${(resumeType === "resume-job-title" && memoizedState.jobPosition === "") ||
            (resumeType === "resume-job-description" && memoizedState.jobDescription === "") ||
            memoizedState.resumeLoading || !session?.user?.email
            ? "opacity-50"
            : ""
